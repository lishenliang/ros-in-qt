...
using namespace std;
//string dir_raw_corner="/home/beihai/my_workspace/src/livox_aftermaped/pcd/corner_frame_raw/";
//string dir_raw_surf="/home/beihai/my_workspace/src/livox_aftermaped/pcd/surf_frame_raw/";
//string dir_align_corner="/home/beihai/my_workspace/src/livox_aftermaped/pcd/corner_frame_align/";
...
void database_initialize(DBoW3::Vocabulary & vocab, DBoW3::Database & database)
{
  vocab.load("/home/beihai/data/vocab/surface_vocabulary.yml.gz");
  database.setVocabulary(vocab,false,0);
  for(size_t i=1;i<=136;i++)
  {
      flann::Matrix<float> surface_descriptor;
      flann::load_from_file(surface_descriptor,"/home/beihai/data/vocab/surface_descriptors.h5","keyframe"+to_string(i));
